...
\begin{align}
\angle Z_{\text{in}}&= \tan^{-1}\left(\frac{-0.5}{3.5}\right)\\
...
\begin{align}
\omega_0 &= \frac{1}{\sqrt{(10 \times 10^{-3} \text{ H})(8 \times 10^{-6} \text{ F})}}\\ &= \frac{1}{\sqrt{8 \times 10^{-8}}}\\
&= 3535.53 \text{ rad/s}
\end{align}
...
\begin{align}
\sigma(8) - 2 &= -2\ln\left(\frac{8}{4}\right)\\
&= -2\ln(2)
\end{align}
