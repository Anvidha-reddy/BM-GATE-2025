...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figs/bm8a.png}
...
Linear convolution can be represented as a matrix-vector product \myvec{y}=\myvec{H}\myvec{x}, where \myvec{H} is a (M+N-1)*N=8 lower-triangular Toeplitz matrix formed by shifting $h(n)$ downwards:
\begin{align}
 \vec{H}=\myvec{ 
   h(0) & 0 \\ 
   h(1) & h(0) \\ 
