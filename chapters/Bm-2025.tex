...
The average power $P_{\text{avg}}$ dissipated in an AC circuit in terms of peak voltage $V_0$ and peak current $I_0$ is given by:

\begin{equation}
P_{\text{avg}} = \frac{1}{2} V_0 I_0 \cos(\phi_v - \phi_i)
\end{equation}
...
P_{\text{avg}} &= \frac{1}{2} \times 50 \times \frac{1}{2} \text{ mW} \\
P_{\text{avg}} &= \frac{50}{4} \text{ mW} \\
P_{\text{avg}} &= 12.5 \text{ mW}
\end{align*}

\text{Correct Option:} \textbf{(b) 12.5}
...
To approximate this Binomial distribution using a Gaussian (Normal) distribution $Y \sim \mathcal{N}(\mu, \sigma^2)$ with the same mean and variance, the Probability Density Function (PDF) is defined as:
\begin{equation}
f_Y(x) = \frac{1}{\sqrt{2\pi \sigma^2}} \exp\left( -\frac{(x - \mu)^2}{2\sigma^2} \right)
\end{equation}
